...
<body class="boardContent">
	<div class="w-100 d-flex justify-content-center align-items-center"
		style="
	            background-image: url('https://i.imgur.com/VQwrm9y.png;
		...
		<form action="#" method="post">
			...
			<div class="border-top p-3">
				<div class="normalCase">
					<div class="w-100">sample 파일</div>
				</div>
				<div class="updateCase" style="display: none;">
					<input class="w-100" type="file" style="font-size: 0.6em">
				</div>
			</div>
				...
				<div class="normalCase">
					<div class="d-flex justify-content-center p-3">
						<div class="btn btn-success text-white mx-2 px-4 fw-bold"
							onclick="window.location.href='./board.jsp'">목록</div>
