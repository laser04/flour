...
<body>
	...
	<div class="mx-auto bg-white rounded mt-5 p-5"
		...
		<div class="d-flex justify-content-between mx-auto"
			style="width: 90%;">
			<div class="text-success fs-2 fw-bolder">뉴스</div>
		...
		<div class="mx-auto mt-4" style="width: 90%;">
			<table id="table-board"
				...
				<tr>
					...
					<td class="text-start"><a href="./newsBoardContent.jsp">감자칩은 감자감자</a></td>
					<td>왕감자</td>
					<td>2023-07-05</td>
					<td>0</td>
				</tr>
				<tr>
					...
					<td class="text-start"><a href="./newsBoardContent.jsp">고구마는 고구고구</a></td>
					<td>왕고구마</td>
					<td>2023-07-06</td>
					<td>0</td>
				</tr>
				<tr>
					...
					<td class="text-start"><a href="./newsBoardContent.jsp">양파는 양파양파</a></td>
					<td>왕고구마</td>
					<td>2023-07-06</td>
					<td>0</td>
				</tr>
			...
			<div class="mt-4 text-end">
				<button class="btn btn-info fs-5 fw-bold px-3"
					onclick="window.location.href='./newsBoardRegister.jsp'">글쓰기</button>
			</div>
		</div>
	</div>
