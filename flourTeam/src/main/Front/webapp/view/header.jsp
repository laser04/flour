			...
			<div class="d-flex align-items-center justify-content-start">
				...
				<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 mb-md-0"
					...
					<li class="dropdown"><a href="#"
						...
						<ul class="dropdown-menu" aria-labelledby="dropdownBoard">
							<li><a class="dropdown-item" href="../view/noticeBoard.jsp">공지사항</a></li>
							<li><a class="dropdown-item" href="../view/newsBoard.jsp">뉴스</a></li>
							<li><a class="dropdown-item" href="../view/board.jsp">자유게시판</a></li>
						</ul></li>
					<li class="dropdown"><a href="#"
						class="nav-link px-2 link-dark dropdown-toggle"
				...
				<div class="d-flex align-items-center">
					<a href="#"
						...
						<img src="https://img.freepik.com/premium-vector/cute-funny-jumping-soy-character_464314-459.jpg?size=626&ext=jpg&ga=GA1.1.557156715.1680836041&semt=ais"
